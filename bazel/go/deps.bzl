...
def go_dependencies():
    ...
    go_repository(
        name = "com_github_alexedwards_scs",
        importpath = "github.com/alexedwards/scs",
        sum = "h1:/5L5a07IlqApODcEfZyMsu8Smd1S7Q4nBjEyKxIRTp0=",
        version = "v1.4.1",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_atedja_go_multilock",
        importpath = "github.com/atedja/go-multilock",
        sum = "h1:osgVLyVcO3XUghYODTtWUjV7O+vmwX70MMtUO2Jiq9E=",
        version = "v0.0.0-20170315063113-31d195f255fb",
    )
    ...
    go_repository(
        name = "com_github_bluekeyes_hatpear",
        importpath = "github.com/bluekeyes/hatpear",
        sum = "h1:FA5diKynoYJi6YVTJPEDbe4MG6eA8h+7LYHUlm8bppc=",
        version = "v0.1.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:zpQSzEApXM0qkXcpdjeJ4OpnBWhD/X8zT/iT1wYLiVU=",
        version = "v0.0.0-20180330214955-e67964b4021a",
    )
    ...
    go_repository(
        name = "com_github_google_go_github_v37",
        importpath = "github.com/google/go-github/v37",
        sum = "h1:rCspN8/6kB1BAJWZfuafvHhyfIo5fkAulaP/3bOQ/tM=",
        version = "v37.0.0",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_metal_stack_metal_robot",
        importpath = "github.com/metal-stack/metal-robot",
        sum = "h1:+vO16CJyke2tQ8egWeGoPhfaZvlx3VvyM3p+5hHvtH8=",
        version = "v0.3.7",
    )

    go_repository(
        name = "com_github_metal_stack_v",
        importpath = "github.com/metal-stack/v",
        sum = "h1:IGtLAGtazQd8r0i/5+YNjBJUEIZYrbVxynY9EXrlTV4=",
        version = "v1.0.2",
    )
    ...
    go_repository(
        name = "com_github_palantir_go_baseapp",
        importpath = "github.com/palantir/go-baseapp",
        sum = "h1:Wi24/LST/cD8qWXtTTgBbeQP4n1kP3164yWoHHeQxYY=",
        version = "v0.2.3",
    )
    go_repository(
        name = "com_github_palantir_go_githubapp",
        importpath = "github.com/palantir/go-githubapp",
        sum = "h1:kuMTREzEj92aYh7BegFCCzKN4vxt6z0RqiOgAcIjxmE=",
        version = "v0.7.0",
    )
    ...
    go_repository(
        ...
        sum = "h1:T9uus1QvcPgeLShS30YOnnzk3r9Vvygp45muhlrufgY=",
        version = "v0.0.0-20191127044304-8f68eb5628d0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:faPjl9wh4hcwTel3iMl5ABxxqVrWTMt0dHCsHh2TXAo=",
        version = "v5.14.0",
    )
